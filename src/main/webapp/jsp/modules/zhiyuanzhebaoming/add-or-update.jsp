		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑志愿者报名</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑志愿者报名</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">志愿者报名信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>报名意愿</label>
										<textarea name="baomingyiyuan" class="form-control" id="baomingyiyuan" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>报名日期</label>
										<div id="baomingriqiDate" class="input-append date form_datetime">
											<input id="baomingriqi-input" name="baomingriqi" size="15" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "zhiyuanzhebaoming/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("zhiyuanzhebaoming/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function dateTimePick(){
			...
			$("#baomingriqiDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			$("#baomingyiyuan").val(ruleForm.baomingyiyuan);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.baomingyiyuan != null && res.data.baomingyiyuan != ''){

					$("#baomingyiyuan").val(res.data.baomingyiyuan);
					}
