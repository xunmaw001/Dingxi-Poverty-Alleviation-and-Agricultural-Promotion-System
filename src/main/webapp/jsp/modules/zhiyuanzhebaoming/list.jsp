...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">志愿者报名管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>志愿者报名管理</span></li>
								<li class="breadcrumb-item active"><span>志愿者报名列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">志愿者报名列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>报名意愿</th>
											<th onclick="sort('baomingriqi')">报名日期<i id="baomingriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		var tableName = "zhiyuanzhebaoming";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
        ...
        function getDataList() {
			http("zhiyuanzhebaoming/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function setDataRow(item,number){
			...
			var baomingyiyuanCell  = document.createElement('td');

						  if(item.baomingyiyuan != null && item.baomingyiyuan != "" && item.baomingyiyuan.length >= 11){
			  	baomingyiyuanCell.innerHTML = item.baomingyiyuan.substring(0, 10) + "..."; 
			  }else{
			  	baomingyiyuanCell.innerHTML = item.baomingyiyuan;
			  }


			row.appendChild(baomingyiyuanCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("zhiyuanzhebaoming/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("zhiyuanzhebaoming/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zhiyuanzhebaoming/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("zhiyuanzhebaoming"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"zhiyuanzhebaoming");
