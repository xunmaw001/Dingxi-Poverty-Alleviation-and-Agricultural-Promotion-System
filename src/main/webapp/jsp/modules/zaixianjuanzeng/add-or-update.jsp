		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑在线捐赠</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>在线捐赠管理</span></li>
								<li class="breadcrumb-item active"><span>编辑在线捐赠</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">在线捐赠信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>捐赠物资</label>
										<input id="juanzengwuzi" name="juanzengwuzi" class="form-control" placeholder="捐赠物资">
									</div>
									<div class="form-group col-md-6">
										<label>数量</label>
									...
									<div class="form-group col-md-6">
										<label>捐赠日期</label>
										<div id="juanzengriqiDate" class="input-append date form_datetime">
											<input id="juanzengriqi-input" name="juanzengriqi" size="15" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "zaixianjuanzeng/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("zaixianjuanzeng/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("zaixianjuanzeng/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#juanzengriqiDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function calculationSE(colName){
			//单列求和接口
			http("zaixianjuanzeng"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#juanzengwuzi").val(ruleForm.juanzengwuzi);	
			$("#shuliang").val(ruleForm.shuliang);	
			$("#juanzengriqi-input").val(ruleForm.juanzengriqi);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.juanzengwuzi != null && res.data.juanzengwuzi != ''){

					$("#juanzengwuzi").val(res.data.juanzengwuzi);
					}
					if(res.data != null && res.data != '' && res.data.shuliang != null && res.data.shuliang != ''){

					$("#shuliang").val(res.data.shuliang);
					}
					if(res.data != null && res.data != '' && res.data.juanzengriqi != null && res.data.juanzengriqi != ''){

					$("#juanzengriqi-input").val(res.data.juanzengriqi);
					$('#juanzengriqiFileName').val(res.data.juanzengriqi)
					}
