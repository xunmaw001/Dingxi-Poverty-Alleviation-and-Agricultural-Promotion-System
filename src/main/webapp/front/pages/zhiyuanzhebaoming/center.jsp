						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="lianxidianhua" id="lianxidianhua" placeholder="联系电话" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">报名意愿</label>
							<div class="layui-input-block">
								<input type="text" name="baomingyiyuan" id="baomingyiyuan" placeholder="报名意愿" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">报名日期</label>
							<div class="layui-input-block">
								<input type="text" name="baomingriqi" id="baomingriqi" placeholder="报名日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
