          ...
          <form class="layui-form">
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 0px;">
                <input type="text" id="nongminxingming" name="nongminxingming" placeholder="请输入农民姓名" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 0px;">
                <input type="text" id="fengguangshiji" name="fengguangshiji" placeholder="请输入风光事迹" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
