...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">在线捐赠管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>在线捐赠列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">在线捐赠列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('juanzengwuzi')">捐赠物资<i id="juanzengwuziIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('shuliang')">数量<i id="shuliangIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('juanzengriqi')">捐赠日期<i id="juanzengriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var juanzengwuziCell  = document.createElement('td');

						 juanzengwuziCell.innerHTML = item.juanzengwuzi;


			row.appendChild(juanzengwuziCell);
			...
			var juanzengriqiCell  = document.createElement('td');

						  juanzengriqiCell.innerHTML = item.juanzengriqi;


			row.appendChild(juanzengriqiCell);
		...
		function sh(){
			...
			httpJson("zaixianjuanzeng/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zaixianjuanzeng/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"zaixianjuanzeng");
