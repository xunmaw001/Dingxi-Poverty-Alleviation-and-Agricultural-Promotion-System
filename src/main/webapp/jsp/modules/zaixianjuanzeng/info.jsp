						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="juanzengwuzi" name="juanzengwuzi" class="form-control" v-model="ruleForm.juanzengwuzi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>数量</label>
									...
									<input id="juanzengriqi" name="juanzengriqi" class="form-control" v-model="ruleForm.juanzengriqi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>是否审核</label>
