...
public class ZhiyuanzhebaomingEntity<T> implements Serializable {
	 ...
	 * 设置：报名意愿
	 */
	public void setBaomingyiyuan(String baomingyiyuan) {
		this.baomingyiyuan = baomingyiyuan;
	}
	/**
	 * 获取：报名意愿
	 */
	public String getBaomingyiyuan() {
		return baomingyiyuan;
	}
	/**
	 * 设置：报名日期
	 */
